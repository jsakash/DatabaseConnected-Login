...
func UserRoutes(incomingRoutes *gin.Engine) {
	...
	incomingRoutes.POST("/create", controller.PostCreateUser)
	incomingRoutes.POST("/block/:name", controller.BlockUser)
	incomingRoutes.POST("/unblock/:name", controller.UnblockUser)
